## Project "Foodfy"
### Rocketseat Challenge "Refactoring "Foodfy""
### A component based website to show recipes with the following tecnologies:
* HTML
* CSS
* JavaScript
* Express
...
#### Clone  this project
```
git clone https://github.com/vrigolon/desafio3-foodfy-refactoring.git
```
